                        ...
                        if self.component_ref == "Speech_Synthesis":
                            ...
                            if self.bindspeech > 0: 
                                ...
                                if self.is_service_available(get_name):
                                    ...
                                    self.get_parameter = rospy.Service(get_name, speech_get_parameter1, self.get_speech)
                                ...
                                if self.is_service_available(set_name):
                                    ...
                                    self.set_parameter = rospy.Service(set_name, speech_set_parameter1, self.set_speech) 
        ...
        if self.ENGINE_RECEIVABLE:
            ...
            try:
                ...
                if s_result.set_return == "OK":
                    return speech_set_parameter1Response(s_result.set_return,command_id)
                else :
                    return speech_set_parameter1Response(s_result.set_return,command_id)
                ...
                return speech_set_parameter1Response(returncode_t,command_id)
        else:
    ...
    def get_speech(self,g_req):
        ...
        if self.ENGINE_RECEIVABLE:
            try:
                ...
                print(self.text)
                re = "OK"
                return speech_get_parameter1Response(re,self.text)
